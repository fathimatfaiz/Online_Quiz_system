...
public class Quiz implements ActionListener {
    ...
    public void displayAnswer(){
        ...
        Timer pause = new Timer(2000, new ActionListener(){
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                answer_labelA.setForeground(new Color(25,0,0));
                answer_labelB.setForeground(new Color(25,0,0));
                answer_labelC.setForeground(new Color(25,0,0));
                answer_labelD.setForeground(new Color(25,0,0));
    ...
    public void results(){
        ...
        try{
            String query = "INSERT INTO result(Name, Score) VALUES ('"+userName+"', '"+result+"')";
